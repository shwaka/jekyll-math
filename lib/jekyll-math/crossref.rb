...
Liquid::Template.register_tag('label', Crossref::LabelTag)
Liquid::Template.register_tag('ref', Crossref::RefTag)
Liquid::Template.register_tag('cref', Crossref::CrefTag)

Jekyll::Hooks.register :pages, :post_render do |page|
  if [".md", ".html"].include?(page.ext)
    handler = Crossref::DataHandler.from_page(page)
